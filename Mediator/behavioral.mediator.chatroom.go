...
// En este caso el ChatRoom hace la función de Mediador, maneja los objetos que envían o reciben mensajes
// evitando que las personas tengan que comunicarse entre ellas, incluso si se hacen
// mensajes privados
