...
// El Flyweight se encuentra en este punto al guardar en un arreglo todos los nombres
// diferentes
var allNames []string
...
func NewUser2(fullName string) *User2 {
	// Este método es necesario para darle sentido al Flyweight, ya que agrega
	// un nombre al arreglo en caso de que no este aún guardado y en caso contrario
	// retorna el nombre en la posición que lo encontró
