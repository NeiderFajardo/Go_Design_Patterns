...
// En este caso el estado solo es un número
type State int
// Cada estado es una constante
const (
  OffHook State = iota
  Connecting
  Connected
...
// En Go así es como se implementa el método String a los enumeradores :D
...
// El trigger puede ser cualquiera de los siguientes enumeradores
type Trigger int
...
// Cada estado tiene un arreglo de triggers y estados asociados
// 
...
func main() {
  ...
  // for hasta que el estado sea igual al estado final
