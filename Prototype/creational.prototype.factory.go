...
// Estos son objectos prototipo que nos ayudarán a crear
// la fabrica de prototipos haciendo uso de los métodos definidos abajo
...
//   ↓ lowercase
// Acá hacemos la copia profunda y también modificamos los
